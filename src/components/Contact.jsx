      ...
      <div className="max-w-7xl mx-auto glass-panel border border-white/10 p-8 md:p-16 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 relative z-10">
          <div className="flex flex-col justify-center">
            ...
            <button disabled={loading} type="submit" className={`flex items-center justify-center gap-2 text-white p-5 font-bold uppercase tracking-widest shadow-lg transition-all mt-2 w-full ${loading ? 'bg-gray-600 cursor-not-allowed' : 'bg-primary shadow-primary/20 hover:shadow-primary/40 hover:bg-purple-600'}`}>
              {loading && (
